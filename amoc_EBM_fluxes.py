# This is an updated version to do the AMOC expts.
...
DataArray = ['tdezb1', 'xpgxs', 'xpgxt', 'xpgxx', 'xpgxb', 'xpgxc', 'xpgxr',
			'xpgxe', 'xpgxw', 'xpecy', 'xpgxh', 'xpgxf', 'xpgxa']
...
co2_name = ['PI_ctrl', 'low_Andes', 'low_Tibet', 'high_AIS', 'Sco_ctrl', 'Robo_ctrl',
			'low_Rocky', 'high_Rocky', 'low_mount', 'low_mount_1X', 'half_mount',
			'high_Rocky_lowAIS', 'Get_ctrl']
...
#			legend = ax.legend(loc='center', bbox_to_anchor=(0.15, 0.6, 0.4, 0.35), edgecolor='w', fontsize=6)
	...
	figano.savefig('/home/bridge/nd20983/plots/EBM/EBM_'+'expts-'+DataArray[m+12]+'amoc.png', format='png', dpi=800)
